...
Download the MathWorks Service Host zip file from the [MathWorks website](https://ssd.mathworks.com/supportfiles/downloads/MathWorksServiceHost/v2026.3.0.6/release/win64/managed_mathworksservicehost_2026.3.0.6_package_win64.zip) or by using this command:
```ps1
