...
Download the MathWorks Service Host zip file from the [MathWorks website](https://ssd.mathworks.com/supportfiles/downloads/MathWorksServiceHost/v2026.1.0.2/release/glnxa64/managed_mathworksservicehost_2026.1.0.2_package_glnxa64.zip) or by using this command:
```bash
